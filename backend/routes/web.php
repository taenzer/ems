...
Route::middleware('auth')->group(function () {
    ...
    Route::get('tickets/orders/create', [TicketController::class, 'create'])->name('tickets.orders.create');
    Route::get('tickets/orders/{order}', [TicketController::class, 'showOrder'])->name('tickets.orders.show');
